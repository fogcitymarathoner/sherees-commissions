...
setup(
    ...
    entry_points={
        'console_scripts': [
            'rrg-ar=rrg.scripts.ar_report:ar_report_ep',
            ...
            'rrg-assemble-employees=rrg.scripts.assemble_employees_cache:assemble_employees_cache_ep',
            ...
            'rrg-cache-clients=rrg.scripts.cache_clients:cache_clients_ep',
            'rrg-cache-clients-ar=rrg.scripts.cache_clients_ar:cache_client_accounts_receivable_ep',
            ...
            'rrg-cache-contracts=rrg.scripts.cache_contracts:cache_contracts_ep',
            'rrg-cache-employees-memos=rrg.scripts.cache_employee_memos:cache_employee_memos_ep',
            'rrg-cache-employees=rrg.scripts.cache_employees:cache_employees_ep',
            'rrg-cache-employees-payments=rrg.scripts.cache_employees_payments:cache_employees_payments_ep',
            'rrg-cache-expenses=rrg.scripts.cache_expenses:cache_expenses_ep',
            'rrg-cache-invoices=rrg.scripts.cache_invoices:cache_invoices_ep',
            ...
            'rrg-cache-sherees-invoices=rrg.scripts.cache_sherees_invoices:cache_invoices_ep',
            'rrg-cache-sherees-invoices-items=rrg.scripts.cache_sherees_invoices_items:cache_invoices_items_ep',
            'rrg-cache-states=rrg.scripts.cache_states:cache_states_ep',
            ...
            'rrg-cached-employee=rrg.scripts.cached_employee:cached_employee_ep',
            'rrg-cached-employees=rrg.scripts.cached_employees:cached_employees_ep',
            'rrg-comm=rrg.scripts.commissions:comm_ep',
            ...
            'rrg-edit-employee=rrg.scripts.edit_employee:edit_employee_ep',
            'rrg-edit-open_invoice=rrg.scripts.edit_open_invoice:edit_open_invoice_ep',
            'rrg-edit-timecard=rrg.scripts.edit_timecard:edit_timecard_ep',
            'rrg-employees=rrg.scripts.employees:employees_ep',
            ...
            'rrg-open_invoices=rrg.scripts.open_invoices:open_invoices_ep',
            'rrg-recover-joomla-files=rrg.scripts.recover_joomla_documents:recover_joomla_documents_ep',
            'rrg-reminders=rrg.scripts.reminders:reminders_ep',
            ...
            'rrg-void-timecard=rrg.scripts.void_timecard:void_timecard_ep',
    ...
    scripts=[
            ...
            'rrg/scripts/cache_clients_ar.py',
