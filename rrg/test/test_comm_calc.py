...
class Test:
    ...
    def test_commissions_calc(self):
        ...
        assert 0 == len(doc.findall(
            'contracts/contract/invoices/invoice/invoice-items/invoice-item/commissions-items/invoices-items-commissions-item'))
        ...
        assert 6.0 == empexp
        # (120 - 60 - 6)*.385
        assert 20.79 == commissions_calculation(inv_item_quantity, inv_item_amount, inv_item_cost, employerexpenserate,
                                                percent)
