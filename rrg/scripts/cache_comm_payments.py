...
from rrg.sherees_commissions import \
    cache_comm_payments as cache_commissions_payments
...
parser.add_argument(
    ...
    default='/php-apps/cake.rocketsredglare.com/rrg/data/transactions/invoices/invoice_items/commissions_payments/')
